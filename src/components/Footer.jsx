export const Footer = () => {
    return (
      <>
        ...
        <footer className="footer sm:footer-horizontal footer-center bg-primary text-white p-2">
          <aside>
            <p>
              Copyright © {new Date().getFullYear()} - Todos los derechos reservados por Not Defined.
            </p>
          </aside>
        </footer>
      </>
